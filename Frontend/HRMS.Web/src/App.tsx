...
import { AttendanceOperationsPage } from './pages/attendance/AttendanceOperationsPage.tsx'
import { MyAttendanceExceptionsPage } from './pages/attendance/MyAttendanceExceptionsPage.tsx'
...
import { BankAdvicePage } from './pages/payroll/BankAdvicePage.tsx'
import { PayrollAccountingPage } from './pages/payroll/PayrollAccountingPage.tsx'
import { PayrollAccountingConfigurationPage } from './pages/payroll/PayrollAccountingConfigurationPage.tsx'
import { PayrollRetroPage } from './pages/payroll/PayrollRetroPage.tsx'
import { FinalSettlementPage } from './pages/payroll/FinalSettlementPage.tsx'
            ...
            <>
              ...
              <Route element={<RequireAuth />}>
                <Route element={<AppLayout />}>
                  ...
                  <Route path="payroll/bank-advice" element={<RequirePermission permission={Permissions.payroll.bankAdviceView}><BankAdvicePage /></RequirePermission>} />
                  <Route path="payroll/accounting" element={<RequirePermission permission={Permissions.payroll.accountingView}><PayrollAccountingPage /></RequirePermission>} />
                  <Route path="payroll/accounting/configuration" element={<RequirePermission permission={Permissions.payroll.accountingManageConfiguration}><PayrollAccountingConfigurationPage /></RequirePermission>} />
                  <Route path="payroll/retro" element={<RequirePermission permission={Permissions.payroll.retroView}><PayrollRetroPage /></RequirePermission>} />
                  <Route path="payroll/final-settlements" element={<RequirePermission permission={Permissions.payroll.finalSettlementView}><FinalSettlementPage /></RequirePermission>} />
                  ...
                  <Route path="payroll/reimbursements" element={<RequirePermission permission={Permissions.payroll.reimbursementsView}><ReimbursementsPage /></RequirePermission>} />
