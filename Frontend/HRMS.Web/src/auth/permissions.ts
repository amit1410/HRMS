...
export const Permissions = {
  ...
  payroll: {
    ...
    statutoryFilingView: 'Payroll.StatutoryFiling.View',
    statutoryFilingManage: 'Payroll.StatutoryFiling.Manage',
    statutoryFilingGenerate: 'Payroll.StatutoryFiling.Generate',
    statutoryFilingValidate: 'Payroll.StatutoryFiling.Validate',
    statutoryFilingSubmitForApproval: 'Payroll.StatutoryFiling.SubmitForApproval',
    statutoryFilingApprove: 'Payroll.StatutoryFiling.Approve',
    statutoryFilingSubmit: 'Payroll.StatutoryFiling.Submit',
    statutoryFilingCancel: 'Payroll.StatutoryFiling.Cancel',
    statutoryFilingExport: 'Payroll.StatutoryFiling.Export',
    statutoryFilingViewHistory: 'Payroll.StatutoryFiling.ViewHistory',
    statutoryFilingManageConnections: 'Payroll.StatutoryFiling.ManageConnections',
    ...
    adjustmentsView: 'Payroll.Adjustments.View',
    adjustmentsCreate: 'Payroll.Adjustments.Create',
    adjustmentsSubmit: 'Payroll.Adjustments.Submit',
    adjustmentsApprove: 'Payroll.Adjustments.Approve',
    adjustmentsCancel: 'Payroll.Adjustments.Cancel',
    adjustmentsReverse: 'Payroll.Adjustments.Reverse',
    adjustmentsViewHistory: 'Payroll.Adjustments.ViewHistory',
    inputView: 'PayrollInput.View',
    inputCreate: 'PayrollInput.Create',
    inputImport: 'PayrollInput.Import',
    inputValidate: 'PayrollInput.Validate',
    inputSubmit: 'PayrollInput.Submit',
    inputApprove: 'PayrollInput.Approve',
    inputPost: 'PayrollInput.Post',
    inputCancel: 'PayrollInput.Cancel',
    inputViewAudit: 'PayrollInput.ViewAudit',
    inputConfigureTemplate: 'PayrollInput.ConfigureTemplate',
    offCycleView: 'Payroll.OffCycle.View',
    offCycleCreate: 'Payroll.OffCycle.Create',
    offCycleApprove: 'Payroll.OffCycle.Approve',
    offCycleProcess: 'Payroll.OffCycle.Process',
    offCycleCancel: 'Payroll.OffCycle.Cancel',
    analyticsView: 'Payroll.Analytics.View',
    analyticsConfigure: 'Payroll.Analytics.Configure',
    reconciliationView: 'Payroll.Reconciliation.View',
    reconciliationGenerate: 'Payroll.Reconciliation.Generate',
    reconciliationAcknowledge: 'Payroll.Reconciliation.Acknowledge',
    ...
    yearEndTaxView: 'Payroll.YearEndTax.View',
    yearEndTaxManage: 'Payroll.YearEndTax.Manage',
    yearEndTaxCalculate: 'Payroll.YearEndTax.Calculate',
    yearEndTaxSubmit: 'Payroll.YearEndTax.Submit',
    yearEndTaxApprove: 'Payroll.YearEndTax.Approve',
    yearEndTaxClose: 'Payroll.YearEndTax.Close',
    yearEndTaxViewHistory: 'Payroll.YearEndTax.ViewHistory',
    yearEndTaxExport: 'Payroll.YearEndTax.Export',
  },
  attendance: {
  ...
  separation: {
    ...
    noticeManage: 'Separation.NoticeManage',
    noticeWaive: 'Separation.NoticeWaive',
    reviseApprovedLastWorkingDate: 'Separation.ReviseApprovedLastWorkingDate',
    clearanceViewSelf: 'Separation.Clearance.ViewSelf',
    clearanceViewTeam: 'Separation.Clearance.ViewTeam',
    clearanceViewAll: 'Separation.Clearance.ViewAll',
    clearanceConfigure: 'Separation.Clearance.Configure',
    clearanceStart: 'Separation.Clearance.Start',
    clearanceManageTask: 'Separation.Clearance.ManageTask',
    clearanceWaive: 'Separation.Clearance.Waive',
    clearanceComplete: 'Separation.Clearance.Complete',
