...
export const Permissions = {
  ...
  payroll: {
    ...
    variablePayView: 'Payroll.VariablePay.View',
    variablePayManagePlans: 'Payroll.VariablePay.ManagePlans',
    variablePayCalculate: 'Payroll.VariablePay.Calculate',
    variablePayCreateAward: 'Payroll.VariablePay.CreateAward',
    variablePaySubmit: 'Payroll.VariablePay.Submit',
    variablePayApprove: 'Payroll.VariablePay.Approve',
    variablePayOverride: 'Payroll.VariablePay.Override',
    variablePayCancel: 'Payroll.VariablePay.Cancel',
    variablePayViewHistory: 'Payroll.VariablePay.ViewHistory',
  },
  attendance: {
