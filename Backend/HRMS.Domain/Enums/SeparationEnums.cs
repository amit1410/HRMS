...
public enum EmployeeSeparationEventType { Created, Submitted, ManagerApproved, ManagerRejected, HrApproved, HrRejected, Rejected, Withdrawn, Approved, LwdRevised, LwdChanged, NoticePeriodActivated, NoticeStarted, Cancelled }
