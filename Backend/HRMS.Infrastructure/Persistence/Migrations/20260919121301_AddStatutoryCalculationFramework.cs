        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uan = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    EsiApplicable = table.Column<bool>(type: "bit", nullable: false),
                    EsiNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ProfessionalTaxApplicable = table.Column<bool>(type: "bit", nullable: false),
                    IncomeTaxApplicable = table.Column<bool>(type: "bit", nullable: false),
                    TaxRegime = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeStatutoryProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChangeType = table.Column<int>(type: "int", nullable: false),
                    ChangedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeStatutoryProfileHistories_EmployeeStatutoryProfiles_TenantId_EmployeeStatutoryProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatutoryConfigurationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChangeType = table.Column<int>(type: "int", nullable: false),
                    ChangedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SnapshotJson = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatutoryConfigurationHistories_StatutoryConfigurations_TenantId_StatutoryConfigurationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConfigurationJson = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatutoryConfigurationVersions_StatutoryConfigurations_TenantId_StatutoryConfigurationId",
                        columns: x => new { x.TenantId, x.StatutoryConfigurationId },
                        principalTable: "StatutoryConfigurations",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JurisdictionCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    StatutoryConfigurationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatutoryConfigurationVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    CalculationMetadata = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollStatutoryResults_PayrollResults_TenantId_PayrollResultId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "TenantId", "Id" });
                    table.ForeignKey(
                        name: "FK_PayrollStatutoryResults_StatutoryConfigurationVersions_TenantId_StatutoryConfigurationVersionId",
                        columns: x => new { x.TenantId, x.StatutoryConfigurationVersionId },
                        principalTable: "StatutoryConfigurationVersions",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollStatutoryResults_StatutoryConfigurations_TenantId_StatutoryConfigurationId",
                        columns: x => new { x.TenantId, x.StatutoryConfigurationId },
                        principalTable: "StatutoryConfigurations",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatutoryComponentBasis_SalaryComponents_TenantId_SalaryComponentId",
                        columns: x => new { x.TenantId, x.SalaryComponentId },
                        principalTable: "SalaryComponents",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StatutoryComponentBasis_StatutoryConfigurationVersions_TenantId_StatutoryConfigurationVersionId",
                        columns: x => new { x.TenantId, x.StatutoryConfigurationVersionId },
                        principalTable: "StatutoryConfigurationVersions",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatutorySlabs_StatutoryConfigurationVersions_TenantId_StatutoryConfigurationVersionId",
                        columns: x => new { x.TenantId, x.StatutoryConfigurationVersionId },
                        principalTable: "StatutoryConfigurationVersions",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStatutoryProfileHistories_TenantId_EmployeeStatutoryProfileId_ChangedAtUtc",
                table: "EmployeeStatutoryProfileHistories",
                columns: new[] { "TenantId", "EmployeeStatutoryProfileId", "ChangedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeStatutoryProfiles_TenantId_EmployeeId_EffectiveFrom_EffectiveTo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollStatutoryResults_TenantId_PayrollResultId_StatutoryType",
                table: "PayrollStatutoryResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollStatutoryResults_TenantId_StatutoryConfigurationVersionId",
                table: "PayrollStatutoryResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatutoryComponentBasis_TenantId_StatutoryConfigurationVersionId_SalaryComponentId",
                table: "StatutoryComponentBasis",
                columns: new[] { "TenantId", "StatutoryConfigurationVersionId", "SalaryComponentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StatutoryConfigurationHistories_TenantId_StatutoryConfigurationId_ChangedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatutoryConfigurations_TenantId_JurisdictionCode_StateCode_StatutoryType_IsActive",
                table: "StatutoryConfigurations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatutoryConfigurationVersions_TenantId_StatutoryConfigurationId_EffectiveFrom_EffectiveTo",
                table: "StatutoryConfigurationVersions",
                columns: new[] { "TenantId", "StatutoryConfigurationId", "EffectiveFrom", "EffectiveTo" });

            migrationBuilder.CreateIndex(
                name: "IX_StatutorySlabs_TenantId_StatutoryConfigurationVersionId_Sequence",
