...
namespace HRMS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924092837_EnforceCurrentSeparationDocumentUniquenessModel")]
    partial class EnforceCurrentSeparationDocumentUniquenessModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HRMS.Domain.Entities.Separation.SeparationGeneratedDocument", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmployeeSeparationId", "DocumentType", "CurrentDocumentKey")
                        .IsUnique()
                        .HasFilter("[CurrentDocumentKey] IS NOT NULL");
