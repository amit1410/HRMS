        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PayrollAccountingConfigurationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollAccountingConfigurationVersions_PayrollAccountingConfigurations_TenantId_PayrollAccountingConfigurationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerContributionAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollGLMappings_PayrollAccountingConfigurationVersions_TenantId_ConfigurationVersionId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollGLMappings_PayrollGLAccounts_TenantId_EmployerContributionAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JournalNumber = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ...
                    AccountingConfigurationVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollJournalBatches_PayrollAccountingConfigurationVersions_TenantId_AccountingConfigurationVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PayrollJournalBatchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollJournalHistories_PayrollJournalBatches_TenantId_PayrollJournalBatchId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayrollGLAccountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccountCodeSnapshot = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AccountNameSnapshot = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollJournalLines_PayrollGLAccounts_TenantId_PayrollGLAccountId",
                        columns: x => new { x.TenantId, x.PayrollGLAccountId },
                        principalTable: "PayrollGLAccounts",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollJournalLines_PayrollJournalBatches_TenantId_PayrollJournalBatchId",
                        columns: x => new { x.TenantId, x.PayrollJournalBatchId },
                        principalTable: "PayrollJournalBatches",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PayrollJournalLineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SourceType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollJournalLineSources_PayrollJournalLines_TenantId_PayrollJournalLineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollAccountingConfigurationVersions_TenantId_PayrollAccountingConfigurationId_EffectiveFrom",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollGLMappings_TenantId_ConfigurationVersionId_SalaryComponentId_StatutoryType_Priority",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollJournalBatches_TenantId_AccountingConfigurationVersionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollJournalHistories_TenantId_PayrollJournalBatchId_ChangedAtUtc",
