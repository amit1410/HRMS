        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialNumber = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    ...
                    LastSuccessfulCheckpoint = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    LastSuccessfulSyncAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastAttemptedSyncAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalEmployeeIdentifier = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceEmployeeMappings_AttendanceDevices_TenantId_AttendanceDeviceId",
                        columns: x => new { x.TenantId, x.AttendanceDeviceId },
                        principalTable: "AttendanceDevices",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceEmployeeMappings_Employees_TenantId_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckpointBefore = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CheckpointAfter = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceSyncRuns_AttendanceDevices_TenantId_AttendanceDeviceId",
                        columns: x => new { x.TenantId, x.AttendanceDeviceId },
                        principalTable: "AttendanceDevices",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttendanceDeviceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AttendanceDeviceSyncRunId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    AttendancePunchId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Source = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceIngestionEvents_AttendanceDeviceSyncRuns_TenantId_AttendanceDeviceSyncRunId",
                        columns: x => new { x.TenantId, x.AttendanceDeviceSyncRunId },
                        principalTable: "AttendanceDeviceSyncRuns",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceIngestionEvents_AttendanceDevices_TenantId_AttendanceDeviceId",
                        columns: x => new { x.TenantId, x.AttendanceDeviceId },
                        principalTable: "AttendanceDevices",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceIngestionEvents_AttendancePunches_TenantId_AttendancePunchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceEmployeeMappings_TenantId_AttendanceDeviceId_ExternalEmployeeIdentifier_EffectiveFrom",
                table: "AttendanceDeviceEmployeeMappings",
                columns: new[] { "TenantId", "AttendanceDeviceId", "ExternalEmployeeIdentifier", "EffectiveFrom" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceEmployeeMappings_TenantId_AttendanceDeviceId_ExternalEmployeeIdentifier_Status_EffectiveFrom_EffectiveTo",
                table: "AttendanceDeviceEmployeeMappings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceIngestionEvents_TenantId_AttendanceDeviceSyncRunId",
                table: "AttendanceDeviceIngestionEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceIngestionEvents_TenantId_Source_ExternalEventId",
                table: "AttendanceDeviceIngestionEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceSyncRuns_TenantId_AttendanceDeviceId_StartedAtUtc",
