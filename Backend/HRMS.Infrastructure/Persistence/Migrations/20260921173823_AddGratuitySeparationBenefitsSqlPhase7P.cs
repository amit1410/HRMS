...
{
    /// <inheritdoc />
    public partial class AddGratuitySeparationBenefitsSqlPhase7P : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalSettlementId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    SourceBalanceReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveEncashmentCalculations_FinalSettlementCases_TenantId_FinalSettlementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NoticeSettlementCalculations_FinalSettlementCases_TenantId_FinalSettlementId",
                        columns: x => new { x.TenantId, x.FinalSettlementId },
                        principalTable: "FinalSettlementCases",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GratuityPolicyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    SelectedSalaryComponentIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsResignationEligible = table.Column<bool>(type: "bit", nullable: false),
                    IsRetirementEligible = table.Column<bool>(type: "bit", nullable: false),
                    IsTerminationEligible = table.Column<bool>(type: "bit", nullable: false),
                    IsDeathEligible = table.Column<bool>(type: "bit", nullable: false),
                    IsDisabilityEligible = table.Column<bool>(type: "bit", nullable: false),
                    IsRedundancyEligible = table.Column<bool>(type: "bit", nullable: false),
                    AllowMinimumServiceOverrideForDeath = table.Column<bool>(type: "bit", nullable: false),
                    AllowMinimumServiceOverrideForDisability = table.Column<bool>(type: "bit", nullable: false),
                    IncludeNoticePeriodInService = table.Column<bool>(type: "bit", nullable: false),
                    LeaveEncashmentEnabled = table.Column<bool>(type: "bit", nullable: false),
                    LeaveTypeIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GratuityPolicyVersions_GratuityPolicies_TenantId_GratuityPolicyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GratuityPolicyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GratuityPolicyVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SeparationReason = table.Column<int>(type: "int", nullable: false),
                    ServiceStartDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ...
                    AppliedRoundingRule = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    WageBasisType = table.Column<int>(type: "int", nullable: false),
                    WageBasisAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    WageSnapshotJson = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    NumeratorDays = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    DenominatorDays = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    GrossCalculatedAmount = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    CapApplied = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GratuityCalculations_FinalSettlementCases_TenantId_FinalSettlementId",
                        columns: x => new { x.TenantId, x.FinalSettlementId },
                        principalTable: "FinalSettlementCases",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GratuityCalculations_GratuityPolicies_TenantId_GratuityPolicyId",
                        columns: x => new { x.TenantId, x.GratuityPolicyId },
                        principalTable: "GratuityPolicies",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GratuityCalculations_GratuityPolicyVersions_TenantId_GratuityPolicyVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GratuityPolicyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    GratuityPolicyVersionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationBenefitHistories_FinalSettlementCases_TenantId_FinalSettlementId",
                        columns: x => new { x.TenantId, x.FinalSettlementId },
                        principalTable: "FinalSettlementCases",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationBenefitHistories_GratuityPolicies_TenantId_GratuityPolicyId",
                        columns: x => new { x.TenantId, x.GratuityPolicyId },
                        principalTable: "GratuityPolicies",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationBenefitHistories_GratuityPolicyVersions_TenantId_GratuityPolicyVersionId",
                        columns: x => new { x.TenantId, x.GratuityPolicyVersionId },
                        principalTable: "GratuityPolicyVersions",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GratuityCalculationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GratuityOverrides_GratuityCalculations_TenantId_GratuityCalculationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GratuityOverrides_TenantId_GratuityCalculationId_ApprovedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GratuityPolicyVersions_TenantId_GratuityPolicyId_EffectiveFrom",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveEncashmentCalculations_TenantId_FinalSettlementId_LeaveTypeId",
                table: "LeaveEncashmentCalculations",
