        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PunchAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BusinessDate = table.Column<DateOnly>(type: "date", nullable: false),
                    Direction = table.Column<int>(type: "int", nullable: false),
                    Source = table.Column<int>(type: "int", nullable: false),
                    ExternalPunchId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    DeviceId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CapturedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RawReference = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstPunchAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastPunchAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    IsLateIn = table.Column<bool>(type: "bit", nullable: false),
                    IsEarlyOut = table.Column<bool>(type: "bit", nullable: false),
                    IsGraceApplied = table.Column<bool>(type: "bit", nullable: false),
                    IsSinglePunch = table.Column<bool>(type: "bit", nullable: false),
                    HasMissingInPunch = table.Column<bool>(type: "bit", nullable: false),
                    HasMissingOutPunch = table.Column<bool>(type: "bit", nullable: false),
                    LeaveConflict = table.Column<bool>(type: "bit", nullable: false),
                    RequiresMarkOutApproval = table.Column<bool>(type: "bit", nullable: false),
                    HasInvalidPunchSequence = table.Column<bool>(type: "bit", nullable: false),
                    ProcessedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ProcessingOutcome = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
