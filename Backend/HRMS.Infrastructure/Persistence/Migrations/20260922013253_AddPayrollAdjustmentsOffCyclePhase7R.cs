        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollAdjustmentApplications_PayrollAdjustments_TenantId_PayrollAdjustmentId",
                        columns: x => new { x.TenantId, x.PayrollAdjustmentId },
                        principalTable: "PayrollAdjustments",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollAdjustmentApplications_PayrollResults_TenantId_PayrollResultId",
                        columns: x => new { x.TenantId, x.PayrollResultId },
                        principalTable: "PayrollResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollAdjustmentApplications_PayrollRuns_TenantId_PayrollRunId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollAdjustmentHistories_PayrollAdjustments_TenantId_PayrollAdjustmentId",
                        columns: x => new { x.TenantId, x.PayrollAdjustmentId },
                        principalTable: "PayrollAdjustments",
                        principalColumns: new[] { "TenantId", "Id" },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAdjustmentTypes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollCorrectionSnapshots_PayrollAdjustments_TenantId_PayrollAdjustmentId",
                        columns: x => new { x.TenantId, x.PayrollAdjustmentId },
                        principalTable: "PayrollAdjustments",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollCorrectionSnapshots_PayrollResults_TenantId_OriginalPayrollResultId",
                        columns: x => new { x.TenantId, x.OriginalPayrollResultId },
                        principalTable: "PayrollResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollCorrectionSnapshots_PayrollRuns_TenantId_OriginalPayrollRunId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OriginalPayrollRunId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OriginalPayrollResultId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReversalRunId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollReversals_PayrollResults_TenantId_OriginalPayrollResultId",
                        columns: x => new { x.TenantId, x.OriginalPayrollResultId },
                        principalTable: "PayrollResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollAdjustmentHistories_TenantId_PayrollAdjustmentId_OccurredAtUtc",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_PayrollAdjustments_PayrollAdjustmentReasons_TenantId_ReasonCodeId",
                table: "PayrollAdjustments",
                columns: new[] { "TenantId", "ReasonCodeId" },
