        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowOvertimeSource = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    RequireCreditApproval = table.Column<bool>(type: "bit", nullable: false),
                    AllowPartialDayConsumption = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceWorkDate = table.Column<DateOnly>(type: "date", nullable: false),
                    SourceType = table.Column<int>(type: "int", nullable: false),
                    SourceAttendanceDayId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SourceAttendanceSnapshotId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SourceAttendanceVersion = table.Column<int>(type: "int", nullable: false),
                    SourceOvertimeRequestId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    SourceOvertimeSnapshotId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    SourceKey = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    ConcurrencyVersion = table.Column<int>(type: "int", nullable: false),
                    TenantId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarningId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiresOn = table.Column<DateOnly>(type: "date", nullable: true),
                    SourceReference = table.Column<string>(type: "nvarchar(240)", maxLength: 240, nullable: false),
                    IdempotencyKey = table.Column<string>(type: "nvarchar(240)", maxLength: 240, nullable: false),
