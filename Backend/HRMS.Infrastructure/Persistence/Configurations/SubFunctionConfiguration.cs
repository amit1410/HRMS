...
public class SubFunctionConfiguration : IEntityTypeConfiguration<SubFunction>
{
    public void Configure(EntityTypeBuilder<SubFunction> builder)
    {
        builder.ToTable("SubFunctions");
