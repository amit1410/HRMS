        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RosterDate = table.Column<DateTime>(type: "date", nullable: false),
                    PreviousShiftId = table.Column<Guid>(type: "char(36)", nullable: true),
                    NewShiftId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    UploadBatchId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ShiftCode = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    ShiftName = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false),
                    ...
                    CrossesMidnight = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    RosterUploadBatchId = table.Column<Guid>(type: "char(36)", nullable: false),
                    RowNumber = table.Column<int>(type: "int", nullable: false),
                    EmployeeCode = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    RosterDate = table.Column<DateTime>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RosterUploadRows_RosterUploadBatches_TenantId_RosterUploadBa~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShiftPatternId = table.Column<Guid>(type: "char(36)", nullable: true),
                    DayType = table.Column<int>(type: "int", nullable: false),
                    AssignmentSource = table.Column<int>(type: "int", nullable: false),
                    IsOverride = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsCalendarOverride = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    OriginalShiftId = table.Column<Guid>(type: "char(36)", nullable: true),
                    Comment = table.Column<string>(type: "longtext", nullable: true),
                    EmployeeEmploymentHistoryId = table.Column<Guid>(type: "char(36)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ShiftPatternId = table.Column<Guid>(type: "char(36)", nullable: false),
