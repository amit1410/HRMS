        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveTypeCode = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    LeavePeriod = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    OpeningBalanceText = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    OpeningBalance = table.Column<decimal>(type: "decimal(9,3)", precision: 9, scale: 3, nullable: true),
                    EffectiveDateText = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    ...
                    LeaveTypeId = table.Column<Guid>(type: "char(36)", nullable: true),
                    LeavePeriodId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveBalanceImportRows_LeaveBalanceImportBatches_TenantId_Ba~",
