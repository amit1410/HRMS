        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    BankAdviceBatchId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAdviceHistories_BankAdviceBatches_TenantId_BankAdviceBat~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankAdvicePayments_BankAdviceBatches_TenantId_BankAdviceBatc~",
                        columns: x => new { x.TenantId, x.BankAdviceBatchId },
                        principalTable: "BankAdviceBatches",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
