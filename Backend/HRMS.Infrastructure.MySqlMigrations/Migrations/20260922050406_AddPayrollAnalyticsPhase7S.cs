        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    AcknowledgedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    PayrollReconciliationId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ControlCode = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    Scope = table.Column<int>(type: "int", nullable: false),
                    Severity = table.Column<int>(type: "int", nullable: false),
                    Action = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    ResolutionNote = table.Column<string>(type: "longtext", nullable: true),
                    ResolutionReference = table.Column<string>(type: "longtext", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollReconciliationFindings_PayrollReconciliations_Payroll~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollAnalyticsSnapshots_TenantId_PayrollRunId_SnapshotType~",
                table: "PayrollAnalyticsSnapshots",
                columns: new[] { "TenantId", "PayrollRunId", "SnapshotType", "DataVersion" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PayrollAnomalyFlags_TenantId_PayrollRunId_AnomalyType_Employ~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollReconciliationFindings_TenantId_PayrollReconciliation~",
                table: "PayrollReconciliationFindings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollReconciliations_TenantId_PayrollRunId_ReconciliationT~",
                table: "PayrollReconciliations",
