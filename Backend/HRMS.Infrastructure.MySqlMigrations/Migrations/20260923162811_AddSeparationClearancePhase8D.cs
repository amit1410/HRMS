        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationClearances_EmployeeSeparations_TenantId_EmployeeSe~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    SeparationClearanceId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationClearanceEvents_SeparationClearances_TenantId_Sepa~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerReferenceId = table.Column<Guid>(type: "char(36)", nullable: true),
                    IsMandatory = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RequiresAssetReturn = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationClearanceTemplateItems_SeparationClearanceTemplate~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedRoleId = table.Column<Guid>(type: "char(36)", nullable: true),
                    AssignedDepartmentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    IsMandatory = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RequiresAssetReturn = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RequiresComment = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RequiresEvidence = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    Comment = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
                    BlockingReason = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                    ConcurrencyVersion = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationClearanceTasks_SeparationClearanceTemplateItems_Te~",
                        columns: x => new { x.TenantId, x.TemplateItemId },
                        principalTable: "SeparationClearanceTemplateItems",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationClearanceTasks_SeparationClearances_TenantId_Separ~",
                        columns: x => new { x.TenantId, x.SeparationClearanceId },
                        principalTable: "SeparationClearances",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    SeparationClearanceTaskId = table.Column<Guid>(type: "char(36)", nullable: false),
                    EmployeeId = table.Column<Guid>(type: "char(36)", nullable: false),
                    AssetReference = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    AssetType = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    ...
                    ExpectedReturnDate = table.Column<DateTime>(type: "date", nullable: true),
                    ...
                    RecoveryRequired = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    RecoveryReference = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationAssetReturns_SeparationClearanceTasks_TenantId_Sep~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeparationClearanceEvents_TenantId_SeparationClearanceId_Occ~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeparationClearanceTemplates_TenantId_EffectiveFrom_Effectiv~",
                table: "SeparationClearanceTemplates",
