        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeparationDate = table.Column<DateTime>(type: "date", nullable: false),
                    LastWorkingDate = table.Column<DateTime>(type: "date", nullable: false),
                    ...
                    DepartmentSnapshot = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                    DesignationSnapshot = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                    LocationSnapshot = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true),
                    DateOfJoiningSnapshot = table.Column<DateTime>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TriggerSourceId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    DetectedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    FinalSettlementCaseId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalSettlementHistories_FinalSettlementCases_TenantId_Final~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEarning = table.Column<bool>(type: "tinyint(1)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalSettlementLines_FinalSettlementCases_TenantId_FinalSett~",
                        columns: x => new { x.TenantId, x.FinalSettlementCaseId },
                        principalTable: "FinalSettlementCases",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    PayrollRetroCaseId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ChangeType = table.Column<int>(type: "int", nullable: false),
                    ChangedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActorUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                    Message = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollRetroHistories_PayrollRetroCases_TenantId_PayrollRetr~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollRetroResults_PayrollResults_TenantId_OriginalPayrollR~",
                        columns: x => new { x.TenantId, x.OriginalPayrollResultId },
                        principalTable: "PayrollResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollRetroResults_PayrollRetroCases_TenantId_PayrollRetroC~",
                        columns: x => new { x.TenantId, x.PayrollRetroCaseId },
                        principalTable: "PayrollRetroCases",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CurrencyCode = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    TargetPayrollRunId = table.Column<Guid>(type: "char(36)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    PayrollRetroResultId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollRetroComponents_PayrollRetroResults_TenantId_PayrollR~",
                        columns: x => new { x.TenantId, x.PayrollRetroResultId },
                        principalTable: "PayrollRetroResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollRetroComponents_SalaryComponents_TenantId_SalaryCompo~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinalSettlementHistories_TenantId_FinalSettlementCaseId_Chan~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRetroHistories_TenantId_PayrollRetroCaseId_ChangedAtU~",
