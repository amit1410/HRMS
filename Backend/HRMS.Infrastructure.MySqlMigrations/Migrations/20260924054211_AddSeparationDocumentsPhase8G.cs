        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyTemplate = table.Column<string>(type: "longtext", maxLength: 100000, nullable: false),
                    HeaderTemplate = table.Column<string>(type: "longtext", maxLength: 20000, nullable: true),
                    FooterTemplate = table.Column<string>(type: "longtext", maxLength: 20000, nullable: true),
                    PageSettingsJson = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationDocumentTemplateVersions_SeparationDocumentTemplat~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentType = table.Column<int>(type: "int", nullable: false),
                    CustomDocumentCode = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: true),
                    TemplateId = table.Column<Guid>(type: "char(36)", nullable: false),
                    TemplateVersionId = table.Column<Guid>(type: "char(36)", nullable: false),
                    DocumentNumber = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    SupersedesDocumentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    SupersededByDocumentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    StorageReference = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    SnapshotJson = table.Column<string>(type: "longtext", maxLength: 100000, nullable: false),
                    ContentBase64 = table.Column<string>(type: "longtext", maxLength: 2000000, nullable: false),
                    LastReason = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    ConcurrencyVersion = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationGeneratedDocuments_EmployeeSeparations_TenantId_Em~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationGeneratedDocuments_SeparationDocumentTemplateVersi~",
                        columns: x => new { x.TenantId, x.TemplateVersionId },
                        principalTable: "SeparationDocumentTemplateVersions",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeparationGeneratedDocuments_SeparationGeneratedDocuments_Su~",
                        column: x => x.SupersededByDocumentId,
                        principalTable: "SeparationGeneratedDocuments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SeparationGeneratedDocuments_SeparationGeneratedDocuments_Te~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateVersionId = table.Column<Guid>(type: "char(36)", nullable: true),
                    GeneratedDocumentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    EventType = table.Column<int>(type: "int", nullable: false),
                    ActorUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                    OccurredAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Reason = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    MetadataJson = table.Column<string>(type: "varchar(10000)", maxLength: 10000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeparationDocumentEvents_SeparationGeneratedDocuments_Tenant~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeparationDocumentEvents_TenantId_GeneratedDocumentId_Occurr~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeparationDocumentTemplateVersions_TenantId_TemplateId_Effec~",
                table: "SeparationDocumentTemplateVersions",
                columns: new[] { "TenantId", "TemplateId", "EffectiveFrom" });

            migrationBuilder.CreateIndex(
                name: "IX_SeparationDocumentTemplateVersions_TenantId_TemplateId_Versi~",
                table: "SeparationDocumentTemplateVersions",
