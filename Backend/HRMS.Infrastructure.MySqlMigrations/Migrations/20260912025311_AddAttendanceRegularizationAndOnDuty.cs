        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmittedByUserId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ...
                    ReviewerComments = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reason = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: false),
                    ProposedInAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ProposedOutAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    SubmittedByUserId = table.Column<Guid>(type: "char(36)", nullable: false),
                    SubmittedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ReviewedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRegularizationRequests_Employees_TenantId_Employee~",
                        columns: x => new { x.TenantId, x.EmployeeId },
                        principalTable: "Employees",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AttendanceRegularizationRequests_Users_TenantId_SubmittedByU~",
                        columns: x => new { x.TenantId, x.SubmittedByUserId },
                        principalTable: "Users",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    AttendanceOnDutyRequestId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceOnDutyEvents_AttendanceOnDutyRequests_TenantId_Att~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<Guid>(type: "char(36)", nullable: false),
                    BusinessDate = table.Column<DateTime>(type: "date", nullable: false),
                    AttendanceRegularizationRequestId = table.Column<Guid>(type: "char(36)", nullable: false),
                    EffectiveInAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    EffectiveOutAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ApprovedByUserId = table.Column<Guid>(type: "char(36)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceAdjustments_AttendanceRegularizationRequests_Tenan~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRegularizationEvents_AttendanceRegularizationReque~",
                        columns: x => new { x.TenantId, x.AttendanceRegularizationRequestId },
                        principalTable: "AttendanceRegularizationRequests",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceAdjustments_TenantId_AttendanceRegularizationReque~",
                table: "AttendanceAdjustments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceOnDutyEvents_TenantId_AttendanceOnDutyRequestId_Oc~",
                table: "AttendanceOnDutyEvents",
                columns: new[] { "TenantId", "AttendanceOnDutyRequestId", "OccurredAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceOnDutyRequests_TenantId_EmployeeId_StartDate_EndDa~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRegularizationEvents_TenantId_AttendanceRegulariza~",
                table: "AttendanceRegularizationEvents",
                columns: new[] { "TenantId", "AttendanceRegularizationRequestId", "OccurredAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRegularizationRequests_TenantId_EmployeeId_Busines~",
