        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceDayId = table.Column<Guid>(type: "char(36)", nullable: false),
                    ...
                    ResolvedBy = table.Column<Guid>(type: "char(36)", nullable: false),
                    ResolvedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceExceptionResolutions_EmployeeAttendanceDays_Tenant~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceExceptionResolutions_TenantId_AttendanceDayId_Atte~",
                table: "AttendanceExceptionResolutions",
                columns: new[] { "TenantId", "AttendanceDayId", "AttendanceVersion", "ExceptionType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceExceptionResolutions_TenantId_EmployeeId_Exception~",
                table: "AttendanceExceptionResolutions",
