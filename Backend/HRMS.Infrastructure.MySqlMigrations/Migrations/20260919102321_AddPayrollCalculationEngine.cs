        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollCalculationErrors_PayrollRunEmployees_TenantId_Payrol~",
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollCalculationErrors_SalaryComponents_TenantId_SalaryCom~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayrollRunEmployeeId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollResults_EmployeeSalaryAssignments_TenantId_EmployeeSa~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollResults_PayrollRunEmployees_TenantId_PayrollRunEmploy~",
                        columns: x => new { x.TenantId, x.PayrollRunEmployeeId },
                        principalTable: "PayrollRunEmployees",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryStructureComponentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ComponentCode = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    ComponentName = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: false),
                    ...
                    CalculationSource = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false),
                    CalculationMetadata = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollResultComponents_PayrollResults_TenantId_PayrollResul~",
                        columns: x => new { x.TenantId, x.PayrollResultId },
                        principalTable: "PayrollResults",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollResultComponents_SalaryComponents_TenantId_SalaryComp~",
                        columns: x => new { x.TenantId, x.SalaryComponentId },
                        principalTable: "SalaryComponents",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollCalculationHistories_TenantId_PayrollRunId_ChangedAtU~",
