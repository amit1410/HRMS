...
public partial class AddUserInvitations : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex("IX_UserInvitations_TenantId_UserId_Purpose_UsedAtUtc_RevokedAtUtc", "UserInvitations", new[] { "TenantId", "UserId", "Purpose", "UsedAtUtc", "RevokedAtUtc" });
