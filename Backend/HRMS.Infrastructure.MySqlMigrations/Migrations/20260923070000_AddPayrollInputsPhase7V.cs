        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Delimiter = table.Column<string>(type: "varchar(1)", maxLength: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    BatchNumber = table.Column<string>(type: "varchar(60)", maxLength: 60, nullable: false),
                    Name = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                    PayrollPeriodId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    FileHash = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceColumnName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    TargetField = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollInputTemplateColumns_PayrollInputTemplates_TenantId_T~",
                        columns: x => new { x.TenantId, x.TemplateId },
                        principalTable: "PayrollInputTemplates",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeCodeSnapshot = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    SalaryComponentId = table.Column<Guid>(type: "char(36)", nullable: true),
                    ComponentCodeSnapshot = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    InputType = table.Column<int>(type: "int", nullable: false),
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    ValidationMessage = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
                    SourceRowHash = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false),
                    ConcurrencyVersion = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "char(36)", nullable: false),
                    BatchId = table.Column<Guid>(type: "char(36)", nullable: false),
                    LineId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollInputValidationIssues_PayrollInputBatches_TenantId_Ba~",
                        columns: x => new { x.TenantId, x.BatchId },
                        principalTable: "PayrollInputBatches",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollInputValidationIssues_PayrollInputLines_TenantId_Line~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollInputValidationIssues_TenantId_BatchId_Severity_RowNu~",
