        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceSnapshotId = table.Column<Guid>(type: "char(36)", nullable: false),
                    AttendanceVersion = table.Column<int>(type: "int", nullable: false),
                    PolicyId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeMonthlyOvertimes_PayrollAttendanceSnapshots_TenantId~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirePostApproval = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AllowNormalWorkingDay = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    HourlyRateComponentId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReopenReason = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                    ReopenedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PayrollOvertimeSnapshots_AttendancePeriods_TenantId_Attendan~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayrollOvertimeSnapshots_PayrollAttendanceSnapshots_TenantId~",
                        columns: x => new { x.TenantId, x.AttendanceSnapshotId },
                        principalTable: "PayrollAttendanceSnapshots",
                        principalColumns: new[] { "TenantId", "Id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcurrencyVersion = table.Column<int>(type: "int", nullable: false),
                    CorrectionReason = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                    CorrectedByUserId = table.Column<Guid>(type: "char(36)", nullable: true),
                    CorrectedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    TenantId1 = table.Column<Guid>(type: "char(36)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeMonthlyOvertimes_TenantId_AttendancePeriodId_Employ~1",
                table: "EmployeeMonthlyOvertimes",
                columns: new[] { "TenantId", "AttendancePeriodId", "EmployeeId", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeMonthlyOvertimes_TenantId_AttendancePeriodId_Employe~",
                table: "EmployeeMonthlyOvertimes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollOvertimeSnapshots_TenantId_AttendancePeriodId_Employ~1",
                table: "PayrollOvertimeSnapshots",
                columns: new[] { "TenantId", "AttendancePeriodId", "EmployeeId", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PayrollOvertimeSnapshots_TenantId_AttendancePeriodId_Employe~",
                table: "PayrollOvertimeSnapshots",
                columns: new[] { "TenantId", "AttendancePeriodId", "EmployeeId", "IsCurrent" },
                unique: true);
