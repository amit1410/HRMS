...
public sealed record EmployeeCodeRuleDto(Guid Id, string Name, int Priority, bool IsDefault, EmployeeCodeRuleStatus Status, IReadOnlyList<EmployeeCodeConditionDto> Conditions, IReadOnlyList<EmployeeCodeSegmentDto> Segments);
