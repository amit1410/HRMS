/*
  HRMS Complete Database Setup — SQL Server
  ==========================================
  This script creates both databases and their complete schemas.

  USAGE:
    sqlcmd -S <SERVER> -E -i Database\HRMS-Database.sql

  NOTE: The application also applies migrations and seeds data on startup.
  This script is for manual/optional schema creation.

  CREATED: 2026-08-25
  EF CORE VERSION: 10.0.11
  MIGRATIONS: 6 (5 shard + 1 catalog)
*/

-- =====================================================================
-- PART 1: CATALOG DATABASE (Host-to-Tenant routing)
-- =====================================================================
USE [master];
GO
...
-- =====================================================================
-- PART 2: SHARD DATABASE (Application data)
-- =====================================================================
USE [master];
GO
...
PRINT 'Catalog: HRMS_Catalog (Tenants + TenantBranding)';
PRINT 'Shard:   HRMS (22 application tables)';
GO